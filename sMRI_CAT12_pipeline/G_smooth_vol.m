% G_smooth_vol.m
%
% This script smooths volume data. 
%
...
for subj = 1:length(cfg.subjects)
    ...
    files = dir([folder filesep 'mwp1sub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_T1w.nii']);
...
%smooth data
matlabbatch{bnum}.spm.spatial.smooth.data = templist2;
matlabbatch{bnum}.spm.spatial.smooth.fwhm = cfg.sMRInormSmooth; 
