% H_extract_vol_rois.m
%
% This script extract volume estimates from rois. 
%
...
for subj = 1:length(cfg.subjects)
    ...
    files = dir([folder filesep 'catROI_sub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_T1w.xml']);
