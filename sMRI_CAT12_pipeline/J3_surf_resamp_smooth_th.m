% J3_surf_resamp_smooth_th.m
%
% This script resamples and smooths surface data for th. 
%
...
for subj = 1:length(cfg.subjects)
    ...
    files = dir([folder filesep 'lh.thickness.sub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_T1w']);
...
matlabbatch{bnum}.spm.tools.cat.stools.surfresamp.fwhm_surf = 12; %12 mm starting point for thickness, 20 mm for gyrification, complexity
