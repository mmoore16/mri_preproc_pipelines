% J1_surf_resamp_smooth_fd.m
%
% This script resamples and smooths surface data for fd. 
%
...
for subj = 1:length(cfg.subjects)
    ...
    files = dir([folder filesep 'lh.fractaldimension.sub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_T1w']);
