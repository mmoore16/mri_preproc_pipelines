...
for subj = 1:length(cfg.subjects)
    ...
    nii_setOrigin12x(sMRI_img); %set center of mass as origin for smri for possible major translation differences that can cause coreg to fail
    sMRI_tempimg = {'T1'};
