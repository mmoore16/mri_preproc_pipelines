...
for subj = 1:length(cfg.subjects)
    ...
    dMRI_img = {[cfg.outputDirBIDSd 'sub-' cfg.subjects{subj} filesep 'ses-' cfg.sessions{subj} filesep 'dwi' filesep 'esub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_dwi_MD.nii']}; 
...
for subj = 1:length(cfg.subjects)
    ...
    for atlas = 1:length(cfg.atlas)
        ...
        temp_mv_file = [cfg.outputDirBIDSd 'sub-' cfg.subjects{subj} filesep 'ses-' cfg.sessions{subj} filesep 'dwi' filesep cfg.atlas{atlas} '_esub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_dwi_MD.csv'];
...
for atlas = 1:length(cfg.atlas)
    ...
    for subj = 1 
        ...
        temp_csv = readcell([cfg.outputDirBIDSd 'sub-' cfg.subjects{subj} filesep 'ses-' cfg.sessions{subj} filesep 'dwi' filesep cfg.atlas{atlas} '_esub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_dwi_MD.csv']);
    ...
    writecell(temp_combined,[cfg.dMRIoutput filesep 'ROI_' cfg.atlas{atlas} '_dwi_MD.csv']);
    bnum = bnum+1;
