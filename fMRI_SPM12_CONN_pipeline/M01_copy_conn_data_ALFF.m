...
for subj = 1:length(cfg.subjects)
    ...
    temp_in_file = [cfg.outputDirBIDSfcr 'ALFF_01' filesep 'BETA_' cfg.subjectsCONN{subj} '_Condition001_Measure001_Component001.nii']; %assuming matching naming convention for .nii
    temp_copy_file = [cfg.outputDirBIDSf 'sub-' cfg.subjects{subj} filesep 'ses-' cfg.sessions{subj} filesep 'func' filesep 'sub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_task-' cfg.fMRITask '_bold_ALFF.nii'];
