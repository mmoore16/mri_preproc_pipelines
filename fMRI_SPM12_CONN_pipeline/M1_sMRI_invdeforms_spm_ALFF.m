...
for subj = 1:length(cfg.subjects)
    ...
    matlabbatch{bnum}.spm.tools.cat.tools.defs2.images = {{[cfg.outputDirBIDSf 'sub-' cfg.subjects{subj} filesep 'ses-' cfg.sessions{subj} filesep 'func' filesep 'sub-' cfg.subjects{subj} '_ses-' cfg.sessions{subj} '_task-' cfg.fMRITask '_bold_ALFF.nii,1']}};
