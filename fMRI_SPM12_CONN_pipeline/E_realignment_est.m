...
for subj = 1:length(cfg.subjects)
    ...
    matlabbatch{bnum}.spm.spatial.realign.estimate.data = runs;

    % params for estimation
    matlabbatch{bnum}.spm.spatial.realign.estimate.eoptions.quality = 0.9;
    matlabbatch{bnum}.spm.spatial.realign.estimate.eoptions.sep = 4;
    matlabbatch{bnum}.spm.spatial.realign.estimate.eoptions.fwhm = 5;
    matlabbatch{bnum}.spm.spatial.realign.estimate.eoptions.rtm = 1; % register to mean volume
    matlabbatch{bnum}.spm.spatial.realign.estimate.eoptions.interp = 4;
    matlabbatch{bnum}.spm.spatial.realign.estimate.eoptions.wrap = [0 0 0];
    matlabbatch{bnum}.spm.spatial.realign.estimate.eoptions.weight = '';
